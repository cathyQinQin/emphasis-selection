...
def parse_args():
    ...
    parser.add_argument("-i","--input",nargs=1,default="input/ref/gold.txt",help="Input dataset for train model, default is input/ref/gold.txt")
    parser.add_argument("-o","--output",nargs=1,default="input/res/submission.txt",help="Input dataset for train model, default is input/res/submission.txt")
